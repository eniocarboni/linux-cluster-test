...
# **
# Description: script for vagrant provision used last for display cluster status
# - check if node need a manual reboot
# - display cluster status (pcs status)
# **
# Provision order: 
# 00-workarounds.sh
...
# 99-single-show-cluster-status.sh (only on node 1) (this file)
# **
# Provision trigger
